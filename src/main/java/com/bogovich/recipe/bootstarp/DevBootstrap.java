package com.bogovich.recipe.bootstarp;

import com.bogovich.recipe.models.*;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> initData() {
        ...
        UnitOfMeasure teapoonUom = unitOfMeasureRepository.findByDescription("Teaspoon").orElseThrow(null);
        ...
        //get categorise
        Category americanCategory = categoryRepository.findByDescription("American").orElseThrow(null);
        Category mexicanCategory = categoryRepository.findByDescription("Mexican").orElseThrow(null);
